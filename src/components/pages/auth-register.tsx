  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    register.mutate(
      ...
      },
      {
        ...
        onError: () =>
          setSubmitError("No pudimos crear tu cuenta. Verificá los datos e intentá de nuevo."),
      },
    );
  };
        ...
        <Card className="w-full max-w-md border-border/50 shadow-xl shadow-primary/5">
          ...
          <CardContent className="px-7 pt-8 pb-6">
            <div className="mb-7 text-center">
              ...
              <p className="mt-1.5 text-sm text-muted-foreground">Empezá a practicar gratis</p>
            </div>
