...
function useSessionStats() {
	...
	if (!session)
		return { session: null as null, answered: 0, correct: 0, accuracy: 0 };
			...
			<div className="mx-auto max-w-2xl space-y-6">
				...
				<Card className="p-8 text-center">
					...
					<p className="mx-auto mt-2 max-w-sm text-sm text-muted-foreground">
						Te mostramos 10 preguntas al azar. Respondé, aprendé con las
						explicaciones y seguí tu progreso.
					</p>
				...
				<p className="text-center text-xs text-muted-foreground">
					Las preguntas se guardan automáticamente. Podés salir y retomar
					después.
				</p>
			</div>
		);
