  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Conocé cómo funciona Caduceo: preguntas reales de exámenes de residencia, modo práctica por especialidad, estadísticas y más. Gratis.",
      },
    ],
  }),
  ...
  return (
    <PublicLayout>
      ...
      <section className="mx-auto max-w-4xl px-4 pt-20 pb-12 text-center md:pt-28 md:pb-16">
        ...
        <h1 className="text-3xl font-bold tracking-tight md:text-5xl">Cómo funciona Caduceo</h1>
        <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
          Preparate para el examen de residencia médica con preguntas reales, feedback inmediato y
      ...
      <section className="mx-auto max-w-3xl px-4 py-16">
        <div className="text-center mb-10">
          ...
          <p className="mt-3 text-muted-foreground">
            Creemos en la transparencia. Todo el contenido tiene una fuente verificable.
          </p>
        </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Las preguntas fueron extraídas de exámenes y materiales de estudio reales
                  utilizados en la preparación para el concurso de residencias médicas en Argentina.
                  Los PDFs fuente incluyen módulos de neurología, cirugía y exámenes integradores.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-xl border bg-card p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Cada pregunta fue revisada y clasificada por especialidad. Las respuestas
                  correctas están siendo validadas contra los materiales originales para garantizar
                  su precisión.
                </p>
              </div>
            </div>
          ...
          <div className="rounded-xl border bg-card p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Hoy contamos con preguntas de neurología, cirugía y exámenes integradores del
                  Módulo II. Estamos trabajando para agregar más especialidades y exámenes de años
                  anteriores.
                </p>
              </div>
            </div>
      ...
      <section className="mx-auto max-w-3xl px-4 pb-20">
        <div className="rounded-2xl bg-primary/5 border border-primary/20 p-8 md:p-12 text-center">
          ...
          <p className="mt-3 text-muted-foreground max-w-lg mx-auto">
            No necesás tarjeta de crédito. Creá tu cuenta y accedé a las preguntas de muestra al
            instante.
          </p>
