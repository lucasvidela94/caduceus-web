    ...
    <PublicLayout>
      ...
      <section className="mx-auto max-w-4xl px-4 pt-20 pb-12 text-center md:pt-28 md:pb-16">
        ...
        <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
          Preparate para el examen de residencia médica con preguntas reales, feedback
          inmediato y estadísticas detalladas.
        </p>
      </section>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  utilizados en la preparación para el concurso de residencias médicas en
                  Argentina. Los PDFs fuente incluyen módulos de neurología, cirugía y
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  correctas están siendo validadas contra los materiales originales para
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  integradores del Módulo II. Estamos trabajando para agregar más
                  especialidades y exámenes de años anteriores.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-3xl px-4 pb-20">
        <div className="rounded-2xl bg-primary/5 border border-primary/20 p-8 md:p-12 text-center">
          ...
          <p className="mt-3 text-muted-foreground max-w-lg mx-auto">
            No necesás tarjeta de crédito. Creá tu cuenta y accedé a las preguntas
            de muestra al instante.
          </p>
