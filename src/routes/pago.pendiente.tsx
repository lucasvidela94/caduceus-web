    ...
    <div className="flex min-h-svh items-center justify-center p-4">
      <Card className="w-full max-w-md p-8 text-center">
        ...
        <p className="mt-2 text-muted-foreground">
          Tu pago está siendo procesado por Mercado Pago. Podés tardar unos minutos en ver reflejado
          el acceso Plus.
        </p>

        <div className="mt-6 rounded-lg bg-muted/50 p-4 text-sm text-muted-foreground">
          <p>
            Si el pago se aprueba, tu cuenta se actualizará automáticamente. Si tenés dudas, volvé
            al panel en unos minutos.
          </p>
        </div>
