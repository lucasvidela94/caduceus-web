...
export const Route = createFileRoute("/auth/login")({
	head: () => ({
		meta: [
			{ title: "Ingresá a Caduceo — Preparación para residencia médica" },
			{ name: "description", content: "Ingresá a tu cuenta de Caduceo para seguir practicando con preguntas reales de examen de residencia médica." },
		],
	}),
	component: LoginPage,
});
